...
`testlib.h` được chuyển từ `testlib.pas` vào năm 2005 và vẫn được cập nhật liên
tục. Testlib tương thích với phần lớn trình biên dịch, chẳng hạn VC++ và GCC g++,
đồng thời tương thích với C++11.
