...
Nếu đang dùng C++ để chuẩn bị một bài thi lập trình, Testlib là công cụ hỗ trợ rất tốt để viết các chương trình liên quan như trình sinh dữ liệu (generator), trình xác thực dữ liệu (validator), trình kiểm tra đáp án (checker) và trình tương tác (interactor). Đây là công cụ gần như bắt buộc với nhiều người ra đề ở Nga và một số quốc gia khác; nhiều kỳ thi cũng sử dụng Testlib, chẳng hạn ROI, các vòng ICPC khu vực và toàn bộ các vòng Codeforces.
