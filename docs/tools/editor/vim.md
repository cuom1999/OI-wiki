...
-   [Bảng tóm tắt Vimscript](https://devhints.io/vimscript)
-   [Học Vimscript theo cách khó](https://learnvimscriptthehardway.stevelosh.com)
-   [Linux vi/vim | Hướng dẫn Runoob](https://www.runoob.com/linux/linux-vim.html)
