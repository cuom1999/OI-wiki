...
Thứ tự byte có hai loại: đầu nhỏ và đầu lớn.
...
Đầu nhỏ nghĩa là máy lưu đối tượng trong bộ nhớ theo thứ tự từ byte có trọng số **thấp nhất** đến byte có trọng số **cao nhất**.
...
Đầu lớn nghĩa là máy lưu đối tượng trong bộ nhớ theo thứ tự từ byte có trọng số **cao nhất** đến byte có trọng số **thấp nhất**.
