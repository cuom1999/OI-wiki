...
Thứ tự byte có hai loại: đầu nhỏ (little endian) và đầu lớn (big endian).
...
Thực ra, không có thứ tự byte nào tốt hơn thứ tự còn lại. Tên gọi "little endian" ("đầu nhỏ") và "big endian" ("đầu lớn") bắt nguồn từ tác phẩm *Gulliver's Travels*. Trong truyện, hai phe ở xứ Lilliput giao chiến không ngừng vì không thống nhất được nên đập trứng từ đầu nhỏ hay đầu to. Tương tự cuộc tranh luận về cách đập trứng, việc chọn thứ tự byte nào không phải là một vấn đề kỹ thuật.
