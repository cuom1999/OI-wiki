...
Trong một số bài toán, khi chuyển trạng thái giữa các đoạn, thao tác thêm hoặc xóa có thể khó cài đặt. Khi chỉ thao tác thêm khó cài đặt, hoặc chỉ thao tác xóa khó cài đặt, có thể dùng Mo có khôi phục trạng thái, thường gọi là Mo rollback, để giải trong thời gian $O(n \sqrt m)$. Ý tưởng cốt lõi của Mo có khôi phục trạng thái là: nếu chỉ cài đặt thuận tiện được một thao tác, thì chỉ dùng thao tác đó, phần còn lại giao cho cơ chế khôi phục trạng thái xử lý.
