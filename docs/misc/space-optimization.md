...
Entropy thông tin mô tả cận dưới của không gian cần để lưu trữ dữ liệu. Nếu không gian thực tế có thể dùng thấp hơn cận dưới này, thông tin chắc chắn sẽ bị mất.
...
vì vậy ta cần ít nhất $\log_2 n$ bit để lưu một số nguyên từ $1$ đến $n$.

### Bài tập ví dụ

???+ note "[\[WC2022\] Đoán từ](https://www.luogu.com.cn/problem/P8079)"
    Bài tương tác, bạn cần đoán một từ gồm 5 chữ cái trong số lần hữu hạn. Mỗi lần đoán phải đoán một từ tồn tại trong từ điển. Nếu đoán đúng, trò chơi kết thúc; sau mỗi lần đoán sai, thư viện tương tác sẽ trả về những chữ cái nào ở đúng vị trí, và những chữ cái nào xuất hiện trong từ cần đoán nhưng ở sai vị trí.
    
    ??? note "Lời giải"
        Tham khảo [Giải câu đố Wordle bằng lý thuyết thông tin - 3Blue1Brown](https://www.bilibili.com/video/BV1zZ4y1k7Jw).
        
        Xét việc tính entropy thông tin. Rõ ràng, mỗi lần đoán chọn từ có entropy thông tin cao sẽ làm số lần đoán kỳ vọng nhỏ nhất có thể.
        
        Vì bài này cho biết chữ cái đầu của đáp án trước khi đoán, ta có thể tiền xử lý lựa chọn đoán tối ưu cho từng chữ cái đầu.
        
        Ngoài ra, nếu số từ còn lại rất ít, ta có thể ưu tiên xuất ra những từ có khả năng là đáp án, từ đó giảm số lần đoán.
...
-   Trong [cây đoạn bền vững](../ds/persistent-seg.md), vì mỗi lần sửa đổi chỉ sinh ra $O(\log n)$ nút mới, ta không cần lưu trữ đầy đủ cây đoạn của mọi phiên bản, mà chỉ cần ghi lại các nút mới.
...
-   Trong [DP ba lô](../dp/knapsack.md), với ba lô 01, mỗi lần tính giá trị DP chỉ dùng dữ liệu của lần tính trước, nên ta có thể dùng mảng cuốn để tối ưu không gian và chỉ cần ghi lại giá trị DP hiện tại.
