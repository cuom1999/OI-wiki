...
Một số trong một hệ ghi số là một chuỗi ký hiệu, đi kèm một bộ quy tắc ánh xạ chuỗi ký hiệu đó với một số tương ứng. Ví dụ số La Mã $\text{XLII}$, số nhị phân $101010_{(2)}$ và số thập phân $42$ đều có thể tương ứng với cùng một số.

Trong lập trình thi đấu, thường chỉ quan tâm đến quan hệ chuyển đổi giữa các hệ ghi số khác nhau; xem chi tiết tại [hệ cơ số](./base.md).
