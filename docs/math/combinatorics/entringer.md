...
Với số hoán vị zigzag $Z_n$ ([OEIS A001250](http://oeis.org/A001250)), dãy bắt đầu từ $n=0$ là:
...
Với $n>1$, mỗi hoán vị zigzag khi đảo ngược vẫn là một hoán vị zigzag, nên chúng có thể ghép cặp từng đôi một; do đó số lượng là số chẵn.
...
Nếu hoán đổi vị trí của $1$ và $n$, của $2$ và $n-1$, rồi tiếp tục như vậy, phép biến đổi này đưa tập hoán vị luân phiên thành tập hoán vị phản luân phiên và ngược lại. Vì vậy, số hoán vị luân phiên và số hoán vị phản luân phiên bằng nhau, đúng bằng một nửa số hoán vị zigzag.
...
$A_n$ được gọi là số zigzag (Euler zigzag number, [OEIS A000111](http://oeis.org/A000111)); dãy bắt đầu từ $n=0$ là:
...
Xét hoán vị $w$ gồm $n+1$ phần tử: đặt đảo ngược của $u$ ở đầu, nối thêm $n+1$, rồi nối thêm $v$. Khi đó $w$ là một hoán vị zigzag; hơn nữa, mọi hoán vị zigzag gồm $n+1$ phần tử đều có thể cắt tại $n+1$ để thu được các hoán vị phản luân phiên tương ứng $u$ và $v$, và các hoán vị zigzag khác nhau tương ứng với các cặp $u$ và $v$ khác nhau.
...
Đây là một tích chập của hàm sinh mũ. Giả sử hàm sinh mũ của $A_n$ là $y$, thu được phương trình vi phân:
...
Thay số hạng thứ $0$ bằng $1$, thu được nghiệm riêng:
...
Theo định nghĩa của số Entringer, $E(n,k)$ là số hoán vị luân phiên của các số từ $0$ đến $n$ có phần tử đầu tiên là $k$. Vì vậy số Entringer có liên hệ với số zigzag:
...
Do đó, với khai triển Taylor tại $x=0$, số sec và số tang được biểu diễn như sau:
