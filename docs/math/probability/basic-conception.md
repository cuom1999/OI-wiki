...
Khi nghiên cứu một hiện tượng ngẫu nhiên cụ thể, cần xác định rõ những biến cố nào là đối tượng quan tâm. Theo định nghĩa của biến cố ngẫu nhiên, luôn có $\mathcal{F} \subset 2^{\Omega}$, trong đó ký hiệu $2^{\Omega}$ chỉ tập lũy thừa của $\Omega$, nhưng không nhất thiết phải có $\mathcal{F} = 2^{\Omega}$. Khi không gian mẫu $\Omega$ là hữu hạn, điều này có thể khó hình dung, vì dù $2^{\Omega}$ lớn hơn nhưng vẫn hữu hạn. Tuy nhiên, khi $\Omega$ là một tập vô hạn, lực lượng của $2^{\Omega}$ trở nên lớn hơn nhiều; trong đó khó tránh khỏi một số biến cố có "tính chất không thuận lợi" và cũng không thuộc phạm vi quan tâm. Khi ấy, việc hy sinh một số tính chất mong muốn chỉ để bao quát các biến cố này là không đáng.
