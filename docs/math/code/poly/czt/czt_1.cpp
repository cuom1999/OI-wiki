...
// Trả về mảng căn đơn vị cần cho FFT độ dài n, có độ dài bằng một nửa.
...
// sau đó tính các hệ số bậc cao của fg. Điều này tương đương tính fg mod x^m,
// rồi bỏ phần hệ số bị "lẫn".
