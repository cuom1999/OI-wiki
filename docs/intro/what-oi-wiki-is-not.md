...
## OI Wiki không phải nơi công bố nghiên cứu gốc

Với tư cách là một wiki, **OI Wiki** không phải nơi công bố
[nghiên cứu gốc](https://en.wikipedia.org/wiki/Wikipedia:No_original_research)
...
Là một trang tổng hợp tri thức chủ yếu xoay quanh lập trình thi đấu, **OI Wiki**
...
-   Thực hiện bất kỳ hình thức quảng bá nào: vì nhu cầu thu nhận tri thức,
    ...
    **OI Wiki** không chấp nhận nội dung có tính quảng bá từ bất kỳ bên nào
    không phải nhà tài trợ.

## OI Wiki không phải cơ quan thẩm quyền

Là một dự án cộng đồng chủ yếu dựa vào đóng góp của người dùng, **OI Wiki**
...
## OI Wiki không phải ủy ban chuẩn hóa dịch thuật

Đối tượng chính của **OI Wiki** không phải nhà sử học hay nhà ngôn ngữ học. Vì
...
Nội dung **OI Wiki** thu nhận nên giới hạn trong phần kiến thức khoa học máy
tính, toán học,... **đã được ứng dụng trong lập trình thi đấu**. Các lĩnh vực
hoặc kiến thức không liên quan đến lập trình thi đấu đều không phù hợp.

Ví dụ, các lĩnh vực hoặc kiến thức sau **không phù hợp** để đưa vào
**OI Wiki**:

-   Lịch sử, nghệ thuật và các lĩnh vực không liên quan.
-   [Ma trận TBN](https://learnopengl.com/Advanced-Lighting/Normal-Mapping),
    tuy thuộc một lĩnh vực kỹ thuật, nhưng hiện chưa dùng trong lập trình thi
    đấu.
-   [Điều khiển PID](https://en.wikipedia.org/wiki/PID_controller),
    [phương pháp phần tử hữu hạn](https://en.wikipedia.org/wiki/Finite_element_method)
    và các thuật toán lĩnh vực hiện chưa dùng trong lập trình thi đấu.
-   [Deep learning](https://en.wikipedia.org/wiki/Deep_learning),
    [reinforcement learning](https://en.wikipedia.org/wiki/Reinforcement_learning)
    và các thuật toán tổng quát hiện chưa dùng trong lập trình thi đấu.

## OI Wiki không phải tài liệu hoặc giáo trình ngôn ngữ lập trình
...
thu nhận những nội dung như "chi tiết cài đặt của một hàm trong thư viện chuẩn
của một ngôn ngữ" khi chúng ít liên quan đến lập trình thi đấu và thuật toán.
