Trước khi bắt đầu, toàn thể thành viên dự án **OI Wiki** rất hoan nghênh bạn
đóng góp trang cho dự án. Chính nhờ hàng trăm người như bạn mà **OI Wiki** mới
có được diện mạo hôm nay!

Bài viết này chủ yếu mô tả quy trình tham gia biên soạn **OI Wiki**. Trước khi
viết bài hoặc sửa trang Wiki, vui lòng đọc kỹ nội dung dưới đây để giúp bạn tạo
ra nội dung có chất lượng cao hơn.
...
nghị bạn cân nhắc các điểm sau trước khi chỉnh sửa:

1.  **Chọn lĩnh vực bạn quen thuộc**: hãy ưu tiên chỉnh sửa những mục từ liên
    quan đến chuyên môn, nền tảng học tập hoặc sở thích của bạn. Điều này giúp
    bạn tạo ra nội dung chất lượng cao.
2.  **Thận trọng với lĩnh vực mới**: nếu bạn mới bắt đầu học hoặc chưa hiểu rõ
    một chủ đề, nên đọc và học thêm để hiểu sâu hơn, rồi hãy chỉnh sửa khi đã
    có đủ sự chắc chắn.
3.  **Tra cứu tài liệu liên quan**: khi thêm nội dung hoặc sửa đổi một mục từ,
    ...
    chính xác. Bạn cũng có thể đặt câu hỏi ở khu bình luận của trang hoặc trong
...
cũng hiểu trình độ chuyên môn của mỗi người không giống nhau. Hãy cùng hợp tác,
cùng gìn giữ khu vườn tri thức này, dùng nội dung chính xác và chuyên nghiệp để
giúp nhiều độc giả hơn. Chúng tôi mong chờ đóng góp của bạn! Xin trích một câu
từ Wikipedia:

> Đừng sợ chỉnh sửa, hãy mạnh dạn cập nhật trang![^ref1]

### Chỉnh sửa trên GitHub

Việc tham gia biên soạn **OI Wiki** **cần** một tài khoản GitHub (bạn có thể
đăng ký tại [trang đăng ký tài khoản GitHub](https://github.com/signup)), nhưng
**không cần** kỹ năng GitHub cao siêu. Ngay cả khi bạn là người mới, chỉ cần làm
theo các bước dưới đây, bạn vẫn có thể hoàn thành việc chỉnh sửa **rất tốt**.

???+ tip "Gợi ý"
    Trước khi thay đổi của bạn được hợp nhất vào kho chính của **OI Wiki**, mọi
    sửa đổi bạn thực hiện với nội dung **OI Wiki** đều sẽ không xuất hiện trên
    trang chính của **OI Wiki**, nên không cần lo thay đổi của bạn làm hỏng nội
...
2.  Nhấn nút **"Chỉnh sửa trang này"** (<i class="md-icon">edit</i>) ở phía
    trên bên phải phần nội dung chính (bên trái mục lục). Sau khi xác nhận bạn
    đã đọc trang này và [sổ tay định dạng](./format.md), nhấn nút theo hướng
    dẫn để chuyển đến GitHub và chỉnh sửa;
3.  Viết nội dung bạn muốn sửa trong khung chỉnh sửa. Lưu ý rằng trong quá
    trình sửa và commit tiếp theo, hãy **tắt phần mềm dịch tự động** của bạn,
...
Trong thời gian chờ hợp nhất, bạn có thể góp ý, thả thích hoặc không thích cho
Pull Request của người khác. Nếu có tin mới, trang web sẽ hiển thị thông báo ở
góc trên bên phải và gửi email nhắc nhở (tùy theo cách bạn cấu hình thông báo
trong cài đặt cá nhân).

#### Chỉnh sửa nội dung trong nhiều trang

Nếu bạn cần chỉnh sửa đồng thời nội dung của nhiều trang không liên quan với
nhau, hãy làm theo phần [chỉnh sửa nội dung trong một trang](#chinh-sua-noi-dung-trong-mot-trang)
...
3.  Bạn sẽ được chuyển đến kho nhánh của mình, và tên nhánh ở góc trên bên trái
    ...
    là `patch-1`).
4.  Thực hiện những thay đổi bạn cần.
    -   Nếu bạn cần chỉnh sửa một tệp đơn lẻ hoặc nội dung của nhiều trang không
...
Mặc dù trong đa số trường hợp bạn có thể chỉnh sửa trực tiếp trên GitHub, với
...
2.  Nếu cần mô tả thêm nội dung commit lần này, hãy trình bày chi tiết trong
    phần thân.
