...
Tương tự phần trên, xem toàn bộ quá trình DP như một chuỗi truy vấn và cập nhật. Với một số bài, tính tuần tự có độ phức tạp quá cao; có thể đưa toàn bộ truy vấn và cập nhật về dạng ngoại tuyến rồi dùng chia để trị CDQ để tăng tốc.
...
và thu được đáp án cuối. Vì một thao tác $F$ thường có thể viết dưới dạng ma trận, phương pháp này thường được gọi là tối ưu DP bằng lũy thừa ma trận nhanh. Tổng quát hơn, mọi phép biến đổi thỏa tính kết hợp (tức mọi phần tử trong một [vị nhóm](../../math/algebra/basic.md#nhóm)) đều có thể dùng phương pháp này để tăng tốc.
