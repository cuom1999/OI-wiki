...
Ve truc giac hinh hoc, $\operatorname{epi}h$ chinh la [tong Minkowski](../../geometry/convex-hull.md#%E9%97%B5%E5%8F%AF%E5%A4%AB%E6%96%AF%E5%9F%BA%E5%92%8C) cua $\operatorname{epi}f$ va $\operatorname{epi}g$. Neu $f$ va $g$ deu la ham tuyen tinh tung doan, thi $h$ cung la ham tuyen tinh tung doan, va cac doan do doc cua no co the xem la ket qua tron (roi sap xep lai) cac doan do doc cua $f$ va $g$.
