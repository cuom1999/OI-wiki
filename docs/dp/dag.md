...
Vì chiều dài và chiều rộng đáy của mỗi khối phải nhỏ hơn nghiêm ngặt so với khối bên dưới, quan hệ này có thể được dùng làm cơ sở dựng đồ thị. Khi đó bài toán được chuyển thành bài toán đường đi dài nhất.
...
Có thể tách mỗi khối thành ba cách xếp, tức là xem một khối ban đầu như ba khối khác nhau, mỗi khối sau khi tách chọn một cạnh khác nhau làm chiều cao.
...
Bài yêu cầu chiều cao lớn nhất của tháp, và nội dung trên đã chuyển yêu cầu này thành bài toán đường đi dài nhất. Điểm bắt đầu là mặt đất như đã nêu; còn điểm kết thúc cũng được xác định tự nhiên: đó là khi trên một khối nào đó không thể đặt thêm khối nào khác.

Tiếp theo xét phương trình chuyển trạng thái.
