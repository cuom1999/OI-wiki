...
-   Loạt sách của Liu Rujia
    ...
    -   *Nghệ thuật thuật toán và thi đấu tin học* (sách xanh/đen)
-   *Hướng dẫn nâng cao về lập trình thi đấu* - Li Yudong
    -   [Kho tài nguyên đi kèm](https://github.com/lydrainbowcat/tedukuri)
-   *Aha! Thuật toán* - Ji Lei
    -   Hướng đến người mới bắt đầu hoặc người mới có hứng thú, có hình minh họa hài hước.
-   Loạt sách CCF về lập trình máy tính cho học sinh trung học
    -   *CCF: Lập trình máy tính cho học sinh trung học - Nhập môn* - Chen Ying, Qiu Guixiang, Zhu Quanmin
        -   [Nên đọc kèm bản đính chính.](https://zhuanlan.zhihu.com/p/85215961)
    -   *CCF: Lập trình máy tính cho học sinh trung học - Cơ sở* - Jiang Tao, Song Xinbo, Zhu Quanmin
    -   *CCF: Lập trình máy tính cho học sinh trung học - Nâng cao* - Xu Xianyou, Zhu Quanmin
    -   *CCF: Lập trình máy tính cho học sinh trung học - Chuyên sâu* (chưa xuất bản)
-   Loạt *Từ nông đến sâu*
    -   *Từ nông đến sâu về lập trình thi đấu - Cơ sở* - nhóm nghiên cứu giảng dạy Luogu Online School
-   Loạt *Một cuốn thông*
    -   *Một cuốn thông về Olympic Tin học* - Dong Yongjian
    -   *Một cuốn thông về Olympic Tin học - Nâng cao* - Huang Xinjun, Dong Yongjian
        -   [Nên đọc có chọn lọc.](https://www.zhihu.com/question/292926937)
    -   *Một cuốn thông về Olympic Tin học - Luyện cao thủ* - Huang Xinjun, Dong Yongjian
-   Các giáo trình khác do những huấn luyện viên OI nổi tiếng ở Trung Quốc viết
    -   *Bài học thông suốt về Olympic Tin học* - Lin Houcong
    -   *Trò chơi của người thông minh: Khám phá tin học - Nâng cao* - Jiang Tao, Chen Maoxian
    -   *Khái luận tính toán: Nhập môn lập trình C++ và thi đấu tin học* - Jin Jing
    -   *Bảo điển lập trình thi đấu* - Zhang Xinhua
-   Loạt ACM International Collegiate Programming Contest
    -   *Loạt ACM ICPC: Kiến thức và nhập môn* - Yu Yong
    -   *Loạt ACM ICPC: Thuật toán và hiện thực* - Yu Yong
    -   *Loạt ACM ICPC: Đề bài và phân tích* - Yu Yong
...
-   Trọn bộ *Thử thách lập trình thi đấu* - Akiha Takuya, Iwata Yoichi, Kitagawa Yoshitoshi
...
-   [THU: Cấu trúc dữ liệu](https://www.xuetangx.com/course/THU08091000384/)
-   [THU: Hình học tính toán](https://www.xuetangx.com/course/THU08091000327/)
