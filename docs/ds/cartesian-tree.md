...
Khi dùng cây Descartes trong thi đấu,
thường lấy chỉ số mảng làm khóa $k$ trong cặp khóa-giá trị,
và chỉ số mảng $k$ thỏa tính chất cây tìm kiếm nhị phân.
...
vốn là khóa thỏa tính chất cây tìm kiếm nhị phân,
nên nút mới chèn chắc chắn nằm ở **đầu mút phải** của cây.
Nút này không thể là con trái và cũng không có con phải.
...
???+ note "Cây Descartes và Treap"
    Thực ra Treap là một dạng cây Descartes,
    chỉ khác ở chỗ giá trị $w$ trong Treap hoàn toàn ngẫu nhiên.
    Treap có thuật toán dựng tuyến tính;
    nếu sắp xếp trước các khóa $k$,
    có thể dùng thuật toán ngăn xếp đơn điệu ở trên để hoàn thành quá trình dựng cây,
    chỉ là cách này hiếm khi được sử dụng.
...
???+ note "[HDU 1506. Largest Rectangle in a Histogram](https://acm.hdu.edu.cn/showproblem.php?pid=1506)"
    Có $n$ vị trí, chiều cao tại mỗi vị trí là $h_i$;
    tìm hình chữ nhật con có diện tích lớn nhất. Như hình sau:
