...
Có thể giả sử mỗi cạnh đã có sẵn lượng luồng $b(u,v)$, gọi đó là luồng ban đầu. Đồng thời, trong đồ thị mới thêm cạnh từ $u$ đến $v$ với dung lượng $c(u,v) - b(u,v)$. Sau đó xét việc điều chỉnh trên đồ thị mới này.
...
???+ note "[Luogu P14578 - Mẫu: luồng khả thi có cận trên và cận dưới, không có nguồn và đích](https://www.luogu.com.cn/problem/P14578)"
    ...
    Cần xây dựng một phương án sao cho luồng $w_i$ trên mỗi cạnh thỏa mãn ràng buộc $l_i\leq w_i\leq r_i$, đồng thời mọi đỉnh đều cân bằng luồng, tức tổng luồng vào của mỗi đỉnh bằng tổng luồng ra. Nếu không có nghiệm thì báo vô nghiệm.
...
Khi đó có thể thêm một cạnh từ $T$ đến $S$ có cận trên là $\infty$ và cận dưới là $0$, từ đó chuyển bài toán về luồng khả thi có cận trên và cận dưới, không có nguồn và đích.
...
Chạy thêm một lần luồng cực đại từ $S$ đến $T$ trên mạng dư; lấy giá trị luồng khả thi cộng với giá trị luồng cực đại vừa tìm được sẽ cho đáp án.
...
Chạy thêm một lần luồng cực đại từ $T$ đến $S$ trên mạng dư; lấy giá trị luồng khả thi trừ đi giá trị luồng cực đại vừa tìm được sẽ cho đáp án.
