...
Giả sử $G=\langle V, E\rangle$ là đồ thị Hamilton. Khi đó, với mọi tập con thực sự không rỗng $V_1$ của $V$, luôn có $p(G-V_1) \leq |V_1|$, trong đó $p(x)$ là số thành phần liên thông của $x$.

Hệ quả: giả sử $G=\langle V, E\rangle$ là đồ thị nửa Hamilton. Khi đó, với mọi tập con thực sự không rỗng $V_1$ của $V$, luôn có $p(G-V_1) \leq |V_1|+1$, trong đó $p(x)$ là số thành phần liên thông của $x$.
...
Giả sử $G$ là đồ thị vô hướng đơn có $n(n \geq 2)$ đỉnh. Nếu với mọi cặp đỉnh không kề nhau $v_i, v_j$ trong $G$, luôn có $d(v_i)+ d(v_j) \geq n - 1$, thì $G$ có đường đi Hamilton.

Hệ quả 1: giả sử $G$ là đồ thị vô hướng đơn có $n(n \geq 3)$ đỉnh. Nếu với mọi cặp đỉnh không kề nhau $v_i, v_j$ trong $G$, luôn có $d(v_i)+ d(v_j) \geq n$, thì $G$ có chu trình Hamilton, do đó $G$ là đồ thị Hamilton.

Hệ quả 2: giả sử $G$ là đồ thị vô hướng đơn có $n(n \geq 3)$ đỉnh. Nếu với mọi đỉnh $v_i$ trong $G$, luôn có $d(v_i) \geq \frac{n}{2}$, thì $G$ có chu trình Hamilton, do đó $G$ là đồ thị Hamilton.
