...
Tên đầy đủ của thư viện pb\_ds là Policy-Based Data Structures, nghĩa là các cấu
trúc dữ liệu dựa trên chính sách.
...
giao diện của STL. Một số thành phần (như hàng đợi ưu tiên) có đầy đủ chức năng
của thành phần tương ứng trong STL, đồng thời cung cấp thêm nhiều chức năng hơn.
