...
Thư viện chuẩn C++ cung cấp hàm sai phân [`std::adjacent_difference`](https://en.cppreference.com/w/cpp/algorithm/adjacent_difference), được định nghĩa trong tệp header `<numeric>`.
